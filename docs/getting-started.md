...
**See also:** [CV0.M1 — Tracer Bullet](design/cv0-m1-tracer-bullet.md) (schema, endpoints, deploy) · [Principles](design/principles.md) (design guidelines) · [Briefing](project/briefing.md) (why these decisions)
