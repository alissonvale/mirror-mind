...
Father of the narrative family. 48, Lancaster PA, Senior Infrastructure Engineer. The narrative reason the family runs a self-hosted Mirror Mind — he stood up the server and added the others as users.

## Files

**Bio**

- [Profile](profile.md) — narrative background, what he carries, voice, how he uses the mirror

**Identity** — one file per row in the `identity(layer, key, content)` table
