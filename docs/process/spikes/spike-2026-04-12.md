...
**See also:** [Briefing](../../project/briefing.md) (decisions that came from this spike) · [CV0.M1 — Tracer Bullet](../../cv0-m1/tracer-bullet.md) (spec for the first deliverable) · [Roadmap](../../project/roadmap.md) (full delivery path)
