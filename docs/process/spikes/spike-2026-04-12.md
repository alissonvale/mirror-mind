...
- Greenfield (not starting from Henrique's migration)
...
**See also:** [Briefing](../../project/briefing.md) (decisions that came from this spike) · [Design v1](../../design/design-v1.md) (spec for the first deliverable) · [Roadmap](../../project/roadmap.md) (full delivery path)
