...
**CV1.E9 — Voz da Alma — manual smoke + iteration:**
...
- Voz da Alma is core, not extension. Auto-detection ships from day 1 (S3); manual override (S4) is the escape + labeled-data feedback loop, not the primary path.
- Voice naming asymmetry: internal code says "self" (`is_self_moment`, `composeAlmaPrompt`); user-facing UX says "Voz da Alma" (or "Alma"). Junguian terminology stays internal; external language is accessible.
