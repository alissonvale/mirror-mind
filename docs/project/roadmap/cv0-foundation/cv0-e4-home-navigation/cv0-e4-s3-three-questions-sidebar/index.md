...
1. Sidebar nav shows four distinct regions in order: **Conversation**, then three section-headed groups — *Who Am I / What I'm Doing / To Whom I'm Affiliate* — each with its matching link underneath.
2. Cognitive Map is a direct sidebar link (not only reachable via the avatar).
