...
- [CV1.E11 — Scenes](cv1-e11-scenes/) — scene-first home and chrome inversion. The cena pivot crystallized: scene IS the model, personas/orgs/travessias emerge in service. New home at `/inicio` (Variant C: scene cards above, free input below), avatar-only top bar, Memória dashboard at `/memoria`. Strangler — old `/` untouched until cutover. S4 + S7 ✅ 2026-05-02; S1–S3, S5–S6 drafted. [Design](../../../design/scenes-home-design.md).
