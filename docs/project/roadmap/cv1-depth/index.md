...
- [CV1.E14 — Identity Narrative](cv1-e14-narrativa/) ✅ 2026-05-05 — replaces the cognitive-map metaphor with a continuous-read self-portrait at `/narrativa`. Five flat sections (ALMA / IDENTIDADE / COMPORTAMENTO / EXPRESSÃO / ELENCO), no "ego" in the chrome (per directive 2026-05-05). Light synthesis (no LLM). Avatar dropdown flips to "Narrativa"; `/espelho` Sou pane drills here.
