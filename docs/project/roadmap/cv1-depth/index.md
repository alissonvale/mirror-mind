...
- [CV1.E13 — Portraits](cv1-e13-portraits/) ✅ 2026-05-05 — read view for orgs, journeys, and scenes. Every entity link landing on a CRUD form conflated stewardship with reading; this epic extends the `/espelho` metabolism to each territory. All three stories shipped: S1 journey portrait + S2 organization portrait (2026-05-04); S3 scene portrait (2026-05-05). [Design](../../../design/entity-profiles.md).
