...
**See also:** [CV0.M1 — Tracer Bullet](../cv0-m1/tracer-bullet.md) (how these decisions become code) · [Roadmap](roadmap.md) (delivery sequence) · [Spike report](../process/spikes/spike-2026-04-12.md) (experiments that informed these decisions)
